...
const Tasks = () => {
    ...
    const fetchTasks = () => {
        ...
        axios.get(`${backendUrl}/api/tasks?userId=${storedUserId}`)
            .then(res => {
    ...
    const handleUpdate = async (taskId) => {
        ...
        await axios.put(`${backendUrl}/api/tasks/${taskId}`, updatedTaskData)
            .then(res => {
    ...
    const handleDelete = (id) => {
        axios.delete(`${backendUrl}/api/tasks/${id}`)
            .then(() => {
    ...
    const handlePin = (id, currentPinnedStatus) => {
        axios.put(`${backendUrl}/api/tasks/${id}`, { pinned: !currentPinnedStatus })
            .then(() => {
