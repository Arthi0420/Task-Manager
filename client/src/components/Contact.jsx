...
const Contact = ()=>{
    return(
        ...
        <div className=" p-5 ">
            <div class=" max-w-6xl max-lg:max-w-3xl mx-auto bg-[#2e0249] rounded-lg">
            <div class="grid lg:grid-cols-2 items-center gap-14 sm:p-8 p-4  font-[sans-serif]">
                <div className="mt-6">
                    ...
                    <p class="text-m text-gray-300 mt-4 leading-relaxed">Need help or have a query? Contact us and we'll get back to you quickly!.</p>
                ...
                <div class="bg-gray-100 p-6 rounded-lg">
                    <p class="text-xl font-semibold text-gray-800">I'm interested in...</p>
